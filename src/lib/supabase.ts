...
export async function recordScan(scannerId: string, scannedId: string): Promise<void> {
...
export async function incrementPoints(attendeeId: string, points: number): Promise<void> {
  const { error } = await supabase
